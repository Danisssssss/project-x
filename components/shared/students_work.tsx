    ...
    return (
        <div className={styles.wrapper}>
                ...
                <div className={styles.passed}>
                    ...
                    <div className={styles.students}>
                        <div className={styles.student}>
                            ...
                            <div className={styles.name}>Student1</div>
                            <div className={styles.grade}>
                                <input className={styles.input} type="number" placeholder="100"/>
                                из
                                <div className={styles.max_grade}>100</div>
                            </div>
                    ...
                    <div className={styles.students}>
                        <div className={styles.student}>
                            <div className={styles.image}></div>
                            <div className={styles.name}>Student2</div>
                            <div className={styles.grade}>
                                <input className={styles.input} type="number" placeholder="100"/>
                                из
                                <div className={styles.max_grade}>100</div>
            ...
            <div className={styles.right}>
                <div className={styles.task_title}>Введение в программирование</div>
                <div className={styles.task_grades}>
                    <div className={styles.task_passed}>
                        <div className={styles.task_count}>2</div>
                        <p className={styles.text}>Сдано</p>
                    </div>
                    <div className={styles.task_not_passed}>
                        <div className={styles.task_count}>0</div>
